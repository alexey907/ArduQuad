#ifndef _MPU9250Lite_H_
#define _MPU9250Lite_H_
#include <Arduino.h>
#include <Wire.h>
...
#define REG_XA_OFFS_H        0x77 //MPU9250 0x06 //[15:0] XA_OFFS
#define REG_XA_OFFS_L        0x78 //MPU9250 0x06 //[15:0] XA_OFFS
#define REG_YA_OFFS_H        0x7A //MPU9250 0x08 //[15:0] YA_OFFS
#define REG_YA_OFFS_L        0x7B //MPU9250 0x08 //[15:0] YA_OFFS
#define REG_ZA_OFFS_H        0x7D //MPU92500x0A //[15:0] ZA_OFFS
#define REG_ZA_OFFS_L        0x7E //MPU92500x0A //[15:0] ZA_OFFS
...
class MPU9250Lite: public MPUBase {
  public:
